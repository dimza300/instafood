...
class DatabaseHelper {
  ...
  Future<void> _onCreate(Database db, int version) async {
    ...
    await db.insert('content', {
      ...
      'subtitle': 'Jl. Baru',
      'description':
          'mie goreng pedas dengan tambahan telor, batagor kering, dan tulang',
      'file_image': '4.jpeg',
      'rating': 4
    });
    await db.insert('content', {
      ...
      'subtitle': 'Jl. Baru',
      'description':
          'isian ceker 10 biji dengan kuah pedas ditambah toping batagor kering',
      'file_image': '5.jpeg',
      'rating': 2
    });
    await db.insert('content', {
